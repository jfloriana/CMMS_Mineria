...
// In-Memory Database Store for state synchronization
...
app.patch("/api/tickets/:id/transition", (req, res) => {
  ...
  // Acceptance criteria validation: RBAC checks
  // e.g. Solo usuarios con rol "Ingeniero de Mantenimiento" o "Supervisor de Mina" pueden mover de DIAGNÓSTICO a PLANIFICADO
  ...
  // Un ticket sin técnico asignado no puede pasar a EN_REPARACIÓN
